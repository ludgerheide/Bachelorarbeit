...
Für diese Arbeit wurden nur Ladesysteme betrachtet, bei denen bereits ein Testbetrieb im normalen Verkehr stattgefunden hat. In der folgenden Tabelle sind die Namen der Systeme in normaler Schrift aufgeführt. Der Name des Herstellers ist \emph{Kursiv} geschrieben.
\begin{table}[htbp]
