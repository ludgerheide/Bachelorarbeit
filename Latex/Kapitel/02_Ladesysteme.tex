...
\begin{description}
	...
	Erforderliche Genauigkeit der Positionierung des Busses relativ zur Ladestation, so dass die volle Ladeleistung verfügbar ist. Besteht aus zwei translatorischen und einer rotatorischen Komponenten (X, Y, Richtung des Busses)
	\item [Totzeit]
