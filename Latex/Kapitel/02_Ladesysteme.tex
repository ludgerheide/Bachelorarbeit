...
\textsc{BYD} verkauft in Europa einen Elektrobus mit Ladestecker nach IEC 62196-2 ("`Mennekes"'). Durch die Verwendung von zwei Ladesteckern kann dieser Bus mit bis zu 80 kW geladen werden~\cite{bydSpecs4}.\marginpar{Hinweis auf 200kW in Amerika? BVG mit chademo?}
...
Induktiv-dynamische Ladesysteme können die Batterie während der Fahrt aufladen. Wenn die ganze Strecke ausgerüstet ist kann die Batterie sogar entfallen. Während der Fahrt kommt es durch Lenkfehler zu einer lateralen Abweichung von der Ladestrecke. Die Bewegungen der Federung führen zu einem unterschiedlichen Vertikalen Abstand zwischen den Spulen. Um ein Aufestzen auf der Straße zu vermeiden muss das System recht hoch im Bus angebracht werden. Dies führt zu einer niedrigen Effizienz~\cite{5618092}. Es werden nur die jeweils direkt unter dem Bus befindlichen Segmente der Primärspule eingeschaltet, was eine Aufteilung der Spule und Schalttechnologie unter der Straße erfordert.
...
\begin{table}[h!]\centering
	\begin{tabularx}{\textwidth}{lXlr}
		...
		System                         & Kurzname & Ladestrategie        & Totzeit \\
		                               &          &                      & $s$     \\ \midrule
		1x \textsc{IEC 62196-2}        & 40kW     & Nacht \& Gelegenheit & \emph{60} \\
...
\begin{table}[h!]\centering
	\begin{tabularx}{\linewidth}{Xllllll}
		...
		System & Maße fest & Maße frei  & Masse     & Freiheitsgrade & Genauigkeit            & Wandler \\
		       & $l$       & $l$        & $kg$      & $1$            & $m^2,^{\circ}$         & $1$     \\ \midrule
		40kW   & 0         & \emph{50}  & \emph{50} & 0              & 47$m^2$, 360$^{\circ}$ & ??      \\
		200kW  & 198       & \emph{100} & 450       & 1              & ???                    & ??      \\
		375kW  & 1000      & \emph{100} & 185       & 2              & 1,75$m^2$, 2$^{\circ}$ & ??      \\
		Swap   & 0         & 0          & 0         & 0              & irrelevant             & ??      \\ \bottomrule
	\end{tabularx}
