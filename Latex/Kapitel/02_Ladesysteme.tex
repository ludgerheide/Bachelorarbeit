...
\begin{table}\centering
	...
	\end{tabularx}
	\caption{Fahrzeugseitige mechanische Kriterien Ladesysteme}
...
\begin{table}\centering
	\begin{tabularx}{\linewidth}{Xllll}
		...
		& $m^3$     & $m^3$     & $1$            & $1$     \\ \midrule
	\end{tabularx}
	\caption{Stationsseitige mechanische Kriterien Ladesysteme}
...
\begin{table}\centering
	\begin{tabularx}{\linewidth}{XXX}
		...
		System & Leistung & Effizienz \\
		       & $W$      & $\%$       \\ \midrule
	\end{tabularx}
	\caption{Elektrische Kriterien Ladesysteme}
...
\begin{table}\centering
	...
	\end{tabularx}
	\caption{Sicherheitskriterien Ladesysteme}
