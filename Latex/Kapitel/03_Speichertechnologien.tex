...
Im Gegensatz zu den Ladesystemen ist die Produktvielfalt der Speichertechnologien nahezu unbegrenzt. Von daher können hier nicht alle Technologien aufgelistet, sondern nur die für den Einsatz in Elektrobussen wichtigsten. \marginpar{Formulierung?}
...
\marginpar{Kris, sagt die Abbildungen sind so verwirrend}
...
\marginpar{Warum sind Abbildungen nicht h!}
...
Der Blei-Säure-Akkumulator ist eine der ältesten wiederaufladbaren Batterietechnologien und wurde in allen frühen Elektrobussen eingesetzt, zum Beispiel im weltweit ersten Batteriebus, der ab 1900 in Berlin auf der Strecke Anhalter Bahnhof – Stettiner Bahnhof (heute: Nordbahnhof) \cite{Risch:1957}[S. 8f]. \marginpar{alteste\emph{,} wiederaufladbare}
...
Wie bei Blei-Säure-Batterien wird der Elektrolyt in Wasserstoff und Sauerstoff zerlegt. Es sind offene Bauformen und geschlossene Bauformen mit interner Rekombination vorhanden.\marginpar{holprig}
