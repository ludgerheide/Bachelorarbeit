...
\end{description}
Die folgenden Paramter sind in Abschnitt \ref{vergleichstabellen_speichertechnologien} aufgelistet:
\begin{description}
	\item[Maximaler Entladestrom] Es wird er maximale Pulsstrom für einen ca. 30-sekündigen Stromstoß verwendet.\\
	Einheit: $A$
	\item[Innenwiderstand] Sollte kein Innenwiderstand dokumentiert sein, wird als Schätzwert 1\% der Nennleistung verwendet.\\
	Einheit: $m\Omega$
	...
	Einheit: $l$
	\item[Wärmekapazität] Die spezifische Wärmekapzität einer Batterie dieses Typs nach Pesaran~\cite{pesaran2001battery}.\\
...
\begin{table}[h!]\centering
	\begin{tabular}{lrrrrrr}
		\toprule
		Batterie    & Strom & Widerstand & Gewicht & Volumen &                  $c_p$ &  Temperatur \\
		            &   $A$ &  $m\Omega$ &    $kg$ &     $l$ & $\frac{kJ}{kg\cdot K}$ & $^{\circ}C$ \\ \midrule
		Laptopzelle &   7,2 &        1,8 &  0,0485 &  0,0176 &                  0,795 &          45 \\
		Bleiakku    &   180 &        3,5 &      21 &     7,9 &                  0,660 &          50 \\
		LiTiO       &   133 &        1,2 &       2 &     1,4 &                  0,795 &          55 \\
		LiFePO      &   160 &        2,0 &    0,99 &     0,6 &                  0,795 &          45 \\ \bottomrule
	\end{tabular}
