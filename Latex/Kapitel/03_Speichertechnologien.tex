...
\begin{description}
	\item[Energiedichte] Einheit: $\frac{Wh}{l}$ \marginpar{$l$ oder $m^3$?} \marginpar{Energie hängt von der Leistung ab. Wie mache ich das?}
	...
	Einheit: $\Omega$ \marginpar{Innenwiderstand ungenau, eventuell KiBaM \cite{jongerden2008battery} besser. Dann Parameter oder Round-Trip-Effizienz?}
...
\subsection{Sicherheit und Zuverlässigkeit}
\begin{description}
	\item[Lebensdauer, kalendarisch] Die Zeitdauer, bis die Batterie nur noch 80\% der Anfangskapazität hat \cite{Sterner:2014}[S. 269]. \marginpar{Das ist auch wieder von Umweltbedingungen und Belastund abhängig…}\\
	Einheit: $a$
