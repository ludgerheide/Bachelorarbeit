...
\begin{figure}\centering
	...
	\caption{Prinzipdarstellung der Doppelschichtkapazität. Quelle: Elcap (Eigenes Werk) CC BY-SA 3.0, via Wikimedia Commons}
...
\begin{figure}\centering
	...
	\caption{Prinzipdarstellung eines Lithium-Ionen-Akkus mit Kobaltoxid in der positiven Elektrode. Quelle: Cepheiden (Eigenes Werk) CC BY-SA 2.0, via Wikimedia Commons} %TODO: Zitierweise
	\label{abb_LiCoO2}
\end{figure}
