...
Tesla Motors verwendet im Gegensatz zu anderen Herstellern von Elektrofahrzeugen keine speziellen Batterien, sondern generische 18650-Zellen, wie sie in Laptops verwendet werden\marginpar{Beleg!}. In dieser Arbeit wird die Batterie NCR18650B von Panasonic als Beispiel für "`klassische"' Lithium-Ionen-Akkus betrachtet.
