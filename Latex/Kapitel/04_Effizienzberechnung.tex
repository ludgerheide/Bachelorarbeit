...
Die Buslinie 204 führt vom Bahnhof Zoo zum Südkreuz. Ein Umlauf ist 12,8 km lang un dauert ca. 80 Minuten. Sie ist eine innerstädtische Linie mit niedriger Durchschnittsgeschwindigkeit und vielen Beschleunigungs- und Bremsvorgängen. Der Verlauf und ein farbkodiertes Geschwindigkeitsprofil sind in Abbildung \ref{Abb_204} zu sehen.
\begin{figure}\centering
	\includegraphics[height=19cm]{Buslinien2}
	\caption[Verlauf und Geschwindigkeitsprofil der Buslinie 204]{Verlauf und Geschwindigkeitsprofil der Buslinie 204}
	\label{Abb_204}
\end{figure}
...
\begin{figure}\centering
	...
	\caption[Geschwindigkeitsprofil der Buslinie 192]{Geschwindigkeitsprofil der Buslinie 192}
	\label{Abb_192}
\end{figure}
